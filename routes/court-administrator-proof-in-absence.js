...
router.route('/proof-in-absence/court-administrator/styles')
  .get(function(req, res, next) {
    res.render('proof-in-absence/court-administrator/styles', {
      baseurl: baseurl,
      apptitle: apptitle,
      doctitle: 'Styles',
      pagetitle: 'Styles',
...
router.route('/proof-in-absence/court-administrator/personal-details/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/personal-details', {
      baseurl: baseurl,
      apptitle: apptitle,
...
router.route('/proof-in-absence/court-administrator/employment-and-income/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/employment-and-income', {
      baseurl: baseurl,
      apptitle: apptitle,
...
router.route('/proof-in-absence/court-administrator/upload-documents/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/upload-documents', {
      baseurl: baseurl,
      apptitle: apptitle,
  ...
  .post(function(req, res, next) {
    ...
    res.redirect('/proof-in-absence/court-administrator/upload-documents/' + req.params.id + '/?saved=true');
  });

// step process routes
router.route('/proof-in-absence/court-administrator/postal/add-plea/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/postal/add-plea', {
      baseurl: baseurl,
      apptitle: apptitle,
      doctitle: 'Add plea',
      pagetitle: 'Add plea',
  ...
  .post(function(req, res, next) {
    ...
    if (!req.query.change) {
      sOffenceActiveTab = req.session.offenceActiveTab = 'Add or change plea';
      res.redirect('/proof-in-absence/court-administrator/postal/personal-details/' + req.params.id);
    }
    else {
      res.redirect('/proof-in-absence/court-administrator/postal/check-your-answers/' + req.params.id);
    }

  });

router.route('/proof-in-absence/court-administrator/postal/personal-details/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/postal/personal-details', {
      baseurl: baseurl,
      apptitle: apptitle,
      doctitle: 'Personal details',
      pagetitle: 'Personal details',
  ...
  .post(function(req, res, next) {
    ...
    // has the user come from check your answers
    if (!req.query.change) {
      res.redirect('/proof-in-absence/court-administrator/postal/employment-and-income/' + req.params.id);
    }
    else {
      res.redirect('/proof-in-absence/court-administrator/postal/check-your-answers/' + req.params.id);
    }
...
router.route('/proof-in-absence/court-administrator/postal/employment-and-income/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/postal/employment-and-income', {
      baseurl: baseurl,
      apptitle: apptitle,
      doctitle: 'Add employment and income',
      pagetitle: 'Add employment and income',
  ...
  .post(function(req, res, next) {
    ...
    // has the user come from check your answers
    if (!req.query.change) {
      res.redirect('/proof-in-absence/court-administrator/postal/upload-documents/' + req.params.id);
    }
    else {
      res.redirect('/proof-in-absence/court-administrator/postal/check-your-answers/' + req.params.id);
    }
...
router.route('/proof-in-absence/court-administrator/postal/upload-documents/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/postal/upload-documents', {
      baseurl: baseurl,
      apptitle: apptitle,
      doctitle: 'Upload documents',
      pagetitle: 'Upload documents',
...
router.route('/proof-in-absence/court-administrator/postal/check-your-answers/:id/')
  .get(function(req, res, next) {
    entry = dataEngine.getSearchEntry(req.params.id);
    res.render('proof-in-absence/court-administrator/postal/check-your-answers', {
      baseurl: baseurl,
      apptitle: apptitle,
  ...
  router.route('/proof-in-absence/court-administrator/register-view/:id/')
    .get(function(req, res, next) {
      entry = dataEngine.getSearchEntry(req.params.id);
      res.render('proof-in-absence/court-administrator/register-view', {
        baseurl: baseurl,
        apptitle: apptitle,
